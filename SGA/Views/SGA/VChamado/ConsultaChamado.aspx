                        ...
                        <div class="panel-body">
                            <div class="panel-body">
                                ...
                                <%if (!PendBox)
                                    { %>
                                <div class="form-group">
                                    <label for="EnceRelat" class="control-label">Informe o relatório do atendimento: </label>
                                ...
                                <%}
                                    if (ObjStatusChm.Id.Equals(1) && Session["perfil"].Equals("Técnico") && ObjAtend.IdTecnico.Equals(Convert.ToInt32(Session["id"])))
                                    {%>
                                ...
                                <%}
                                    ...
                                    {%>
                                <div class="form-group">
                                    <label for="ComentAvaliacao" class="control-label">Relatório do atendimento: </label>
                                    <textarea rows="5" cols="50" maxlength="500" id="Relat" class="form-control input-sm" disabled runat="server"><%=ObjAtend.Relatorio %></textarea>
                                </div>
                                <div class="form-group">
                                    <label for="ComentAvaliacao" class="control-label">Comentário de avaliação: </label>
                                    <textarea rows="5" cols="50" maxlength="500" id="ComentAvaliacao" class="form-control input-sm" disabled runat="server"><%=ObjAvaliacao.Comentario %></textarea>
                                </div>
                                <%}
                                ...
                                <%}
                                    if (!Session["perfil"].Equals("Cliente Físico") && !Session["perfil"].Equals("Cliente Jurídico") && !CancButtonClick && !TramiteClick && !EnceButtonClick)
                                    { %>
                                ...
                                <%}
                                    if (!Session["perfil"].Equals("Cliente Físico") && !Session["perfil"].Equals("Cliente Jurídico") && !CancButtonClick && !TramiteClick && !EnceButtonClick && ObjStatusChm.Id.Equals(2))
                                    { %>
